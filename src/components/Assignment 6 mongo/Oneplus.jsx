...
export const Oneplus=()=>{
    ...
    const getdata=async()=>{
        const result=await axios.get("http://localhost:3050/alloneplus");
        setData(result.data)
    }
    useEffect(()=>{
       getdata()
   ...
   <Grid container spacing={2}>
         ...
         <Card sx={{bgcolor:"lavender",borderRadius:"45px 0 45px 0",marginTop:"40px",margin:"10px",border:"dotted purple"}}>
            <CardContent>
