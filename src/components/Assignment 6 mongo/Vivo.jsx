...
export const Vivo=()=>{
    ...
    const getdata=async()=>{
        const result=await axios.get("http://localhost:3050/allvivo");
        setData(result.data)
    }
    useEffect(()=>{
       getdata()
   ...
   <Grid container spacing={2}>
         ...
         <Card sx={{bgcolor:"lavender",borderRadius:"55px 0 55px 0",marginTop:"40px",margin:"10px",border:"dotted purple"}}>
            <CardContent>
